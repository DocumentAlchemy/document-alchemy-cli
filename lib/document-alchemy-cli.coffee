    ...
    fs.readdir command_dir, (err,files)=>
      if err?
        ...
        for file in files
          ...
          if match?[1]?
            unless (match[1] in commands) # in case we find both a JS and Coffee file
...
exports.DocumentAlchemyCLI = DocumentAlchemyCLI
exports.main = DocumentAlchemyCLI.main

if require.main is module
  DocumentAlchemyCLI.main()
